      ...
      >
        ...
        <form onSubmit={handleSubmit} className="mt-4 space-y-4">
          <input
            ...
            className="w-full rounded-xl border border-ink/15 bg-surface px-3 py-2 text-sm text-ink outline-none transition-[border-color,box-shadow] duration-[260ms] focus:border-terracotta focus:ring-2 focus:ring-terracotta/25 focus:shadow-[0_0_0_4px_rgba(217,96,63,0.12)]"
          />
